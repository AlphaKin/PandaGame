...
cc._RF.push(module, '0fa466CfdZD25NOz0Ocf9jJ', 'key', __filename);
// script/key.js
...
cc.Class({
    ...
    onBeginContact: function onBeginContact(contact, self, other) {
        if (other.node.group == 'ball') {
            if (self.node.getChildByName("normal").active == true) {
                self.node.getChildByName("normal").active = false;
            } else {
                self.node.getChildByName("normal").active = true;
            }
        }
    },
